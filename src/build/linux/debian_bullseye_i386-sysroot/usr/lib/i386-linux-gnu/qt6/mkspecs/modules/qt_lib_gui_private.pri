...
QT.gui_private.enabled_features = accessibility-atspi-bridge evdev freetype system-freetype fontconfig harfbuzz system-harfbuzz kms drm_atomic libinput libinput-axis-api linuxfb vnc mtdev vkgen vkkhrdisplay egl_x11 eglfs eglfs_egldevice eglfs_gbm eglfs_x11 gif ico jpeg system-jpeg png system-png imageio-text-loading tslib tuiotouch xcb-glx xcb-egl-plugin xcb-xlib xcb-sm xkbcommon xkbcommon-x11 xlib multiprocess raster-64bit raster-fp
QT.gui_private.disabled_features = directfb directwrite directwrite3 direct2d direct2d1_1 qqnx_imf integrityfb integrityhid libinput-hires-wheel-support vsp2 eglfs_brcm eglfs_vsp2 eglfs_mali eglfs_viv eglfs_rcar eglfs_viv_wl eglfs_openwfd xcb-native-painting xrender system-xcb-xinput
QMAKE_INCDIR_ATSPI = /usr/lib/i386-linux-gnu/dbus-1.0/include /usr/lib/i386-linux-gnu/glib-2.0/include
...
QMAKE_LIBS_GBM = -lgbm
QMAKE_INCDIR_HARFBUZZ = /usr/lib/i386-linux-gnu/glib-2.0/include
