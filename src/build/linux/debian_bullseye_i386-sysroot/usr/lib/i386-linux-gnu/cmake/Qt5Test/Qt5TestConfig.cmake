...
get_filename_component(_realOrig "/usr/lib/i386-linux-gnu/cmake/Qt5Test" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Test_install_prefix "/usr/lib/i386-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Test_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Test_install_prefix}/lib/i386-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Test)
    ...
    set(_Qt5Test_OWN_INCLUDE_DIRS "${_qt5Test_install_prefix}/include/i386-linux-gnu/qt5/" "${_qt5Test_install_prefix}/include/i386-linux-gnu/qt5/QtTest")
    set(Qt5Test_PRIVATE_INCLUDE_DIRS
        "${_qt5Test_install_prefix}/include/i386-linux-gnu/qt5/QtTest/5.15.2"
        "${_qt5Test_install_prefix}/include/i386-linux-gnu/qt5/QtTest/5.15.2/QtTest"
    )
    ...
    _populate_Test_target_properties(RELEASE "libQt5Test.so.5.15.2" "" FALSE)
    ...
    macro(_populate_Test_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Test_install_prefix}/lib/i386-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Test_check_file_exists(${imported_location})
