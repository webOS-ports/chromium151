...
get_filename_component(_realOrig "/usr/lib/i386-linux-gnu/cmake/Qt5Core" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Core_install_prefix "/usr/lib/i386-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Core_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Core_install_prefix}/lib/i386-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Core)
    ...
    set(_Qt5Core_OWN_INCLUDE_DIRS "${_qt5Core_install_prefix}/include/i386-linux-gnu/qt5/" "${_qt5Core_install_prefix}/include/i386-linux-gnu/qt5/QtCore")
    set(Qt5Core_PRIVATE_INCLUDE_DIRS
        "${_qt5Core_install_prefix}/include/i386-linux-gnu/qt5/QtCore/5.15.2"
        "${_qt5Core_install_prefix}/include/i386-linux-gnu/qt5/QtCore/5.15.2/QtCore"
    )
    ...
    set_property(TARGET Qt5::Core
                 ...
                 clock-gettime;datetimeparser;doubleconversion;futimens;getauxval;getentropy;glib;glibc;posix-libiconv;hijricalendar;icu;inotify;linkat;poll_ppoll;system-pcre2;renameat2;sha3-fast;statx;system-doubleconversion)
    set_property(TARGET Qt5::Core
                 PROPERTY QT_DISABLED_PRIVATE_FEATURES
                 etw;futimes;gnu-libiconv;iconv;journald;lttng;mimetype-database;poll_poll;poll_pollts;poll_select;slog2;syslog)
    ...
    _populate_Core_target_properties(RELEASE "libQt5Core.so.5.15.2" "" FALSE)
    ...
    macro(_populate_Core_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Core_install_prefix}/lib/i386-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Core_check_file_exists(${imported_location})
