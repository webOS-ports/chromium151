...
get_filename_component(_realOrig "/usr/lib/i386-linux-gnu/cmake/Qt5OpenGLExtensions" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5OpenGLExtensions_install_prefix "/usr/lib/i386-linux-gnu/../../" ABSOLUTE)
else()
...
function(_qt5_OpenGLExtensions_process_prl_file prl_file_location Configuration lib_deps link_flags)
    ...
    set(_qt5_install_libs "${_qt5OpenGLExtensions_install_prefix}/lib/i386-linux-gnu/")
...
macro(_populate_OpenGLExtensions_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5OpenGLExtensions_install_prefix}/lib/i386-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::OpenGLExtensions)
    ...
    set(_Qt5OpenGLExtensions_OWN_INCLUDE_DIRS "${_qt5OpenGLExtensions_install_prefix}/include/i386-linux-gnu/qt5/" "${_qt5OpenGLExtensions_install_prefix}/include/i386-linux-gnu/qt5/QtOpenGLExtensions")
    ...
    if(NOT Qt5_EXCLUDE_STATIC_DEPENDENCIES)
        ...
        _qt5_OpenGLExtensions_process_prl_file(
            "${_qt5OpenGLExtensions_install_prefix}/lib/i386-linux-gnu/libQt5OpenGLExtensions.prl" RELEASE
    ...
    macro(_populate_OpenGLExtensions_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5OpenGLExtensions_install_prefix}/lib/i386-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_OpenGLExtensions_check_file_exists(${imported_location})
