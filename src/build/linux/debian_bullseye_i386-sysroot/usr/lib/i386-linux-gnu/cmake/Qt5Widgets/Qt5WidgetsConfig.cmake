...
get_filename_component(_realOrig "/usr/lib/i386-linux-gnu/cmake/Qt5Widgets" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Widgets_install_prefix "/usr/lib/i386-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Widgets_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Widgets_install_prefix}/lib/i386-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Widgets)
    ...
    set(_Qt5Widgets_OWN_INCLUDE_DIRS "${_qt5Widgets_install_prefix}/include/i386-linux-gnu/qt5/" "${_qt5Widgets_install_prefix}/include/i386-linux-gnu/qt5/QtWidgets")
    set(Qt5Widgets_PRIVATE_INCLUDE_DIRS
        "${_qt5Widgets_install_prefix}/include/i386-linux-gnu/qt5/QtWidgets/5.15.2"
        "${_qt5Widgets_install_prefix}/include/i386-linux-gnu/qt5/QtWidgets/5.15.2/QtWidgets"
    )
    ...
    _populate_Widgets_target_properties(RELEASE "libQt5Widgets.so.5.15.2" "" FALSE)
    ...
    macro(_populate_Widgets_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Widgets_install_prefix}/lib/i386-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Widgets_check_file_exists(${imported_location})
