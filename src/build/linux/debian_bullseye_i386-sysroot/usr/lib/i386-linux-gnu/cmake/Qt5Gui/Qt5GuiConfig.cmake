...
get_filename_component(_realOrig "/usr/lib/i386-linux-gnu/cmake/Qt5Gui" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Gui_install_prefix "/usr/lib/i386-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Gui_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Gui_install_prefix}/lib/i386-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Gui)
    ...
    set(_Qt5Gui_OWN_INCLUDE_DIRS "${_qt5Gui_install_prefix}/include/i386-linux-gnu/qt5/" "${_qt5Gui_install_prefix}/include/i386-linux-gnu/qt5/QtGui")
    set(Qt5Gui_PRIVATE_INCLUDE_DIRS
        "${_qt5Gui_install_prefix}/include/i386-linux-gnu/qt5/QtGui/5.15.2"
        "${_qt5Gui_install_prefix}/include/i386-linux-gnu/qt5/QtGui/5.15.2/QtGui"
    )
    ...
    set_property(TARGET Qt5::Gui PROPERTY INTERFACE_QT_DISABLED_FEATURES opengles2;dynamicgl;angle;combined-angle-lib;opengles3;opengles31;opengles32;openvg)
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 opengles2;dynamicgl;angle;combined-angle-lib;opengles3;opengles31;opengles32;openvg)
    set_property(TARGET Qt5::Gui
    ...
    set_property(TARGET Qt5::Gui
                 ...
                 angle_d3d11_qdtd;direct2d;direct2d1_1;dxgi;direct3d11;direct3d11_1;direct3d9;directfb;dxgi1_2;dxguid;eglfs_brcm;eglfs_mali;eglfs_openwfd;eglfs_rcar;eglfs_viv;eglfs_viv_wl;vsp2;eglfs_vsp2;integrityfb;integrityhid;tslib)
    ...
    macro(_populate_Gui_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Gui_install_prefix}/lib/i386-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Gui_check_file_exists(${imported_location})
