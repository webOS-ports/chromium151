...
get_filename_component(_realOrig "/usr/lib/i386-linux-gnu/cmake/Qt5EglFsKmsSupport" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5EglFsKmsSupport_install_prefix "/usr/lib/i386-linux-gnu/../../" ABSOLUTE)
else()
...
set(Qt5EglFsKmsSupport_VERSION_STRING 5.15.2)
...
macro(_populate_EglFsKmsSupport_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5EglFsKmsSupport_install_prefix}/lib/i386-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::EglFsKmsSupport)
    ...
    foreach(_module_dep ${_Qt5EglFsKmsSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.15.2 ${_Qt5EglFsKmsSupport_FIND_VERSION_EXACT}
    ...
    _populate_EglFsKmsSupport_target_properties(RELEASE "libQt5EglFsKmsSupport.so.5.15.2" "" FALSE)
