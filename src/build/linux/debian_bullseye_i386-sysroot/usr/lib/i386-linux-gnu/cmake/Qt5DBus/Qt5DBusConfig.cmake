...
get_filename_component(_realOrig "/usr/lib/i386-linux-gnu/cmake/Qt5DBus" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5DBus_install_prefix "/usr/lib/i386-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_DBus_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5DBus_install_prefix}/lib/i386-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::DBus)
    ...
    set(_Qt5DBus_OWN_INCLUDE_DIRS "${_qt5DBus_install_prefix}/include/i386-linux-gnu/qt5/" "${_qt5DBus_install_prefix}/include/i386-linux-gnu/qt5/QtDBus")
    set(Qt5DBus_PRIVATE_INCLUDE_DIRS
        "${_qt5DBus_install_prefix}/include/i386-linux-gnu/qt5/QtDBus/5.15.2"
        "${_qt5DBus_install_prefix}/include/i386-linux-gnu/qt5/QtDBus/5.15.2/QtDBus"
    )
    ...
    _populate_DBus_target_properties(RELEASE "libQt5DBus.so.5.15.2" "" FALSE)
    ...
    macro(_populate_DBus_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5DBus_install_prefix}/lib/i386-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_DBus_check_file_exists(${imported_location})
