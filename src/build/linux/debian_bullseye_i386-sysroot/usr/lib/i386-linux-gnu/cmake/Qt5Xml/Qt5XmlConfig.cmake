...
get_filename_component(_realOrig "/usr/lib/i386-linux-gnu/cmake/Qt5Xml" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Xml_install_prefix "/usr/lib/i386-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Xml_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Xml_install_prefix}/lib/i386-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Xml)
    ...
    set(_Qt5Xml_OWN_INCLUDE_DIRS "${_qt5Xml_install_prefix}/include/i386-linux-gnu/qt5/" "${_qt5Xml_install_prefix}/include/i386-linux-gnu/qt5/QtXml")
    set(Qt5Xml_PRIVATE_INCLUDE_DIRS
        "${_qt5Xml_install_prefix}/include/i386-linux-gnu/qt5/QtXml/5.15.2"
        "${_qt5Xml_install_prefix}/include/i386-linux-gnu/qt5/QtXml/5.15.2/QtXml"
    )
    ...
    _populate_Xml_target_properties(RELEASE "libQt5Xml.so.5.15.2" "" FALSE)
    ...
    macro(_populate_Xml_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Xml_install_prefix}/lib/i386-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Xml_check_file_exists(${imported_location})
