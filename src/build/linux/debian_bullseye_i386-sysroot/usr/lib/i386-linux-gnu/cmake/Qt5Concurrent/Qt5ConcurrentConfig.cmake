...
get_filename_component(_realOrig "/usr/lib/i386-linux-gnu/cmake/Qt5Concurrent" REALPATH)
if(_realCurr STREQUAL _realOrig)
    get_filename_component(_qt5Concurrent_install_prefix "/usr/lib/i386-linux-gnu/../../" ABSOLUTE)
else()
...
macro(_populate_Concurrent_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION
    ...
    set(imported_location "${_qt5Concurrent_install_prefix}/lib/i386-linux-gnu/${LIB_LOCATION}")
...
if (NOT TARGET Qt5::Concurrent)
    ...
    set(_Qt5Concurrent_OWN_INCLUDE_DIRS "${_qt5Concurrent_install_prefix}/include/i386-linux-gnu/qt5/" "${_qt5Concurrent_install_prefix}/include/i386-linux-gnu/qt5/QtConcurrent")
    ...
    _populate_Concurrent_target_properties(RELEASE "libQt5Concurrent.so.5.15.2" "" FALSE)
    ...
    macro(_populate_Concurrent_plugin_properties Plugin Configuration PLUGIN_LOCATION
        ...
        set(imported_location "${_qt5Concurrent_install_prefix}/lib/i386-linux-gnu/qt5/plugins/${PLUGIN_LOCATION}")
        _qt5_Concurrent_check_file_exists(${imported_location})
