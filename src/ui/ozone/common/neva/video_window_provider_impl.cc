...
class VideoWindowMojo : public mojom::VideoWindow {
 public:
  ...
  void CommitVideoWindowGeometryIfNeeded(const gfx::Rect& src,
                                         const gfx::Rect& dst,
                                         const std::optional<gfx::Rect>& ori);
 ...
 private:
  ...
  gfx::Rect src_rect_;
  gfx::Rect dst_rect_;
  std::optional<gfx::Rect> ori_rect_ = std::nullopt;
  std::optional<gfx::Size> coded_size_;
...
void VideoWindowMojo::UpdateVideoWindowGeometry(const gfx::Rect& dst) {
  CommitVideoWindowGeometryIfNeeded(src_rect_, dst, std::nullopt);
}
...
void VideoWindowMojo::CommitVideoWindowGeometry() {
  ...
  std::optional<gfx::Size> video_size;
...
void VideoWindowMojo::CommitVideoWindowGeometryIfNeeded(
  ...
  const base::TimeDelta interval =
      base::Milliseconds(kMinVideoGeometryUpdateIntervalMs);
  if (elapsed < interval) {
...
void VideoWindowMojo::UpdateVideoWindowGeometry(const gfx::Rect& src,
  ...
  CommitVideoWindowGeometryIfNeeded(src, dst, std::nullopt);
}
