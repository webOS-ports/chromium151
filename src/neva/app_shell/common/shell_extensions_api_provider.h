...
#ifndef NEVA_APP_SHELL_COMMON_SHELL_EXTENSIONS_API_PROVIDER_H_
#define NEVA_APP_SHELL_COMMON_SHELL_EXTENSIONS_API_PROVIDER_H_
...
#endif  // NEVA_APP_SHELL_COMMON_SHELL_EXTENSIONS_API_PROVIDER_H_
