...
#ifndef NEVA_APP_SHELL_COMMON_SHELL_EXTENSIONS_CLIENT_H_
#define NEVA_APP_SHELL_COMMON_SHELL_EXTENSIONS_CLIENT_H_
...
#endif  // NEVA_APP_SHELL_COMMON_SHELL_EXTENSIONS_CLIENT_H_
