...
#ifndef NEVA_APP_SHELL_TEST_SHELL_APITEST_H_
#define NEVA_APP_SHELL_TEST_SHELL_APITEST_H_

#include <string>

#include "base/files/file_path.h"
#include "neva/app_shell/test/shell_test.h"
...
#endif  // NEVA_APP_SHELL_TEST_SHELL_APITEST_H_
