...
#ifndef NEVA_APP_SHELL_TEST_SHELL_TEST_EXTENSIONS_BROWSER_CLIENT_H_
#define NEVA_APP_SHELL_TEST_SHELL_TEST_EXTENSIONS_BROWSER_CLIENT_H_
...
#endif  // NEVA_APP_SHELL_TEST_SHELL_TEST_EXTENSIONS_BROWSER_CLIENT_H_
