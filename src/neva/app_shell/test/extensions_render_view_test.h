...
#ifndef NEVA_APP_SHELL_TEST_EXTENSIONS_RENDER_VIEW_TEST_H_
#define NEVA_APP_SHELL_TEST_EXTENSIONS_RENDER_VIEW_TEST_H_
...
#endif  // NEVA_APP_SHELL_TEST_EXTENSIONS_RENDER_VIEW_TEST_H_
