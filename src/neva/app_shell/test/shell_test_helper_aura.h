...
#ifndef NEVA_APP_SHELL_TEST_SHELL_TEST_HELPER_AURA_H_
#define NEVA_APP_SHELL_TEST_SHELL_TEST_HELPER_AURA_H_
...
#endif  // NEVA_APP_SHELL_TEST_SHELL_TEST_HELPER_AURA_H_
