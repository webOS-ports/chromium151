...
#ifndef NEVA_APP_SHELL_NEVA_SHELL_PERMISSION_PROMPT_H_
#define NEVA_APP_SHELL_NEVA_SHELL_PERMISSION_PROMPT_H_
...
#endif  // NEVA_APP_SHELL_NEVA_SHELL_PERMISSION_PROMPT_H_
