...
#ifndef NEVA_APP_SHELL_NEVA_PLATFORM_SHUTDOWN_SIGNAL_HANDLER_H_
#define NEVA_APP_SHELL_NEVA_PLATFORM_SHUTDOWN_SIGNAL_HANDLER_H_
...
#endif  // NEVA_APP_SHELL_NEVA_PLATFORM_SHUTDOWN_SIGNAL_HANDLER_H_
