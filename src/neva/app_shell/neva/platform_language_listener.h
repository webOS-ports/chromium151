...
#ifndef NEVA_APP_SHELL_NEVA_PLATFORM_LANGUAGE_LISTENER_H_
#define NEVA_APP_SHELL_NEVA_PLATFORM_LANGUAGE_LISTENER_H_
...
#endif  // NEVA_APP_SHELL_NEVA_PLATFORM_LANGUAGE_LISTENER_H_
