...
#ifndef NEVA_APP_SHELL_NEVA_SHELL_MEDIA_CAPTURE_OBSERVER_H_
#define NEVA_APP_SHELL_NEVA_SHELL_MEDIA_CAPTURE_OBSERVER_H_
...
#endif  // NEVA_APP_SHELL_NEVA_SHELL_MEDIA_CAPTURE_OBSERVER_H_
