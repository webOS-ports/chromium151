...
#ifndef NEVA_APP_SHELL_NEVA_PLATFORM_REGISTER_APP_H_
#define NEVA_APP_SHELL_NEVA_PLATFORM_REGISTER_APP_H_
...
#endif  // NEVA_APP_SHELL_NEVA_PLATFORM_REGISTER_APP_H_
