...
#ifndef NEVA_APP_SHELL_RENDERER_SHELL_EXTENSIONS_RENDERER_CLIENT_H_
#define NEVA_APP_SHELL_RENDERER_SHELL_EXTENSIONS_RENDERER_CLIENT_H_
...
#endif  // NEVA_APP_SHELL_RENDERER_SHELL_EXTENSIONS_RENDERER_CLIENT_H_
