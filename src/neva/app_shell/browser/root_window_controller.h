...
#ifndef NEVA_APP_SHELL_BROWSER_ROOT_WINDOW_CONTROLLER_H_
#define NEVA_APP_SHELL_BROWSER_ROOT_WINDOW_CONTROLLER_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_ROOT_WINDOW_CONTROLLER_H_
