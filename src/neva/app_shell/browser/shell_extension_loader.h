...
#ifndef NEVA_APP_SHELL_BROWSER_SHELL_EXTENSION_LOADER_H_
#define NEVA_APP_SHELL_BROWSER_SHELL_EXTENSION_LOADER_H_
...
#include "neva/app_shell/browser/shell_keep_alive_requester.h"
...
#endif  // NEVA_APP_SHELL_BROWSER_SHELL_EXTENSION_LOADER_H_
