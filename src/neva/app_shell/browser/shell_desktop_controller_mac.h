...
#ifndef NEVA_APP_SHELL_BROWSER_SHELL_DESKTOP_CONTROLLER_MAC_H_
#define NEVA_APP_SHELL_BROWSER_SHELL_DESKTOP_CONTROLLER_MAC_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_SHELL_DESKTOP_CONTROLLER_MAC_H_
