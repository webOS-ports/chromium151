...
#ifndef NEVA_APP_SHELL_BROWSER_SHELL_SPECIAL_STORAGE_POLICY_H_
#define NEVA_APP_SHELL_BROWSER_SHELL_SPECIAL_STORAGE_POLICY_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_SHELL_SPECIAL_STORAGE_POLICY_H_
