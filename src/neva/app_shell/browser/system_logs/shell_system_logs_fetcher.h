...
#ifndef NEVA_APP_SHELL_BROWSER_SYSTEM_LOGS_SHELL_SYSTEM_LOGS_FETCHER_H_
#define NEVA_APP_SHELL_BROWSER_SYSTEM_LOGS_SHELL_SYSTEM_LOGS_FETCHER_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_SYSTEM_LOGS_SHELL_SYSTEM_LOGS_FETCHER_H_
