...
#ifndef NEVA_APP_SHELL_BROWSER_SHELL_APP_WINDOW_CLIENT_H_
#define NEVA_APP_SHELL_BROWSER_SHELL_APP_WINDOW_CLIENT_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_SHELL_APP_WINDOW_CLIENT_H_
