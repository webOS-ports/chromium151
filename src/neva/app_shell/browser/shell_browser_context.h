...
#ifndef NEVA_APP_SHELL_BROWSER_SHELL_BROWSER_CONTEXT_H_
#define NEVA_APP_SHELL_BROWSER_SHELL_BROWSER_CONTEXT_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_SHELL_BROWSER_CONTEXT_H_
