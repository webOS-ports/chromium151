...
#ifndef NEVA_APP_SHELL_BROWSER_SHELL_KEEP_ALIVE_REQUESTER_H_
#define NEVA_APP_SHELL_BROWSER_SHELL_KEEP_ALIVE_REQUESTER_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_SHELL_KEEP_ALIVE_REQUESTER_H_
