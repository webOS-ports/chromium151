...
#ifndef NEVA_APP_SHELL_BROWSER_SHELL_AUDIO_CONTROLLER_CHROMEOS_H_
#define NEVA_APP_SHELL_BROWSER_SHELL_AUDIO_CONTROLLER_CHROMEOS_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_SHELL_AUDIO_CONTROLLER_CHROMEOS_H_
