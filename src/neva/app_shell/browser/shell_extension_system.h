...
#ifndef NEVA_APP_SHELL_BROWSER_SHELL_EXTENSION_SYSTEM_H_
#define NEVA_APP_SHELL_BROWSER_SHELL_EXTENSION_SYSTEM_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_SHELL_EXTENSION_SYSTEM_H_
