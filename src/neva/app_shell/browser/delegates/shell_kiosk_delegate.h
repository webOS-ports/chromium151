...
#ifndef NEVA_APP_SHELL_BROWSER_DELEGATES_SHELL_KIOSK_DELEGATE_H_
#define NEVA_APP_SHELL_BROWSER_DELEGATES_SHELL_KIOSK_DELEGATE_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_DELEGATES_SHELL_KIOSK_DELEGATE_H_
