...
#ifndef NEVA_APP_SHELL_BROWSER_SHELL_NATIVE_APP_WINDOW_AURA_H_
#define NEVA_APP_SHELL_BROWSER_SHELL_NATIVE_APP_WINDOW_AURA_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_SHELL_NATIVE_APP_WINDOW_AURA_H_
