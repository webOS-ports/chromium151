...
#ifndef NEVA_APP_SHELL_BROWSER_SHELL_NAVIGATION_UI_DATA_H_
#define NEVA_APP_SHELL_BROWSER_SHELL_NAVIGATION_UI_DATA_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_SHELL_NAVIGATION_UI_DATA_H_
