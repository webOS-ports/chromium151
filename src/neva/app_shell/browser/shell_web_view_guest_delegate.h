...
#ifndef NEVA_APP_SHELL_BROWSER_SHELL_WEB_VIEW_GUEST_DELEGATE_H_
#define NEVA_APP_SHELL_BROWSER_SHELL_WEB_VIEW_GUEST_DELEGATE_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_SHELL_WEB_VIEW_GUEST_DELEGATE_H_
