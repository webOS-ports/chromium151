...
#ifndef NEVA_APP_SHELL_BROWSER_SHELL_VIRTUAL_KEYBOARD_DELEGATE_H_
#define NEVA_APP_SHELL_BROWSER_SHELL_VIRTUAL_KEYBOARD_DELEGATE_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_SHELL_VIRTUAL_KEYBOARD_DELEGATE_H_
