...
// Vendored from extensions/browser/media_capture_util.{h,cc}: M151 deleted
// extensions/shell along with this helper, which only app_shell used.
#ifndef NEVA_APP_SHELL_BROWSER_MEDIA_CAPTURE_UTIL_H_
#define NEVA_APP_SHELL_BROWSER_MEDIA_CAPTURE_UTIL_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_MEDIA_CAPTURE_UTIL_H_
