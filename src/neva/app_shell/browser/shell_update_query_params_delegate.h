...
#ifndef NEVA_APP_SHELL_BROWSER_SHELL_UPDATE_QUERY_PARAMS_DELEGATE_H_
#define NEVA_APP_SHELL_BROWSER_SHELL_UPDATE_QUERY_PARAMS_DELEGATE_H_
...
#endif  // NEVA_APP_SHELL_BROWSER_SHELL_UPDATE_QUERY_PARAMS_DELEGATE_H_
