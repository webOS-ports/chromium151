...
//
// This file is based on shell/shell/browser/net/proxying_url_loader_factory.cc
...
AppRuntimeProxyingURLLoaderFactory::InProgressRequest::FollowRedirectParams::
    FollowRedirectParams() = default;
AppRuntimeProxyingURLLoaderFactory::InProgressRequest::FollowRedirectParams::
    ~FollowRedirectParams() = default;

AppRuntimeProxyingURLLoaderFactory::InProgressRequest::InProgressRequest(
    AppRuntimeProxyingURLLoaderFactory* factory,
  ...
  target_client_.set_disconnect_handler(base::BindOnce(
      &AppRuntimeProxyingURLLoaderFactory::InProgressRequest::OnRequestError,
...
AppRuntimeProxyingURLLoaderFactory::InProgressRequest::~InProgressRequest() {
  ...
  if (info_) {
    factory_->web_request_listener()->OnRequestWillBeDestroyed(&info_.value());
  }
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::Restart() {
  UpdateRequestInfo();
  RestartInternal();
}

void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::UpdateRequestInfo() {
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::RestartInternal() {
  ...
  redirect_url_ = GURL();
  int result = factory_->web_request_listener()->OnBeforeRequest(
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::SetPriority(
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::PauseReadingBodyFromNet() {
  if (target_loader_.is_bound())
    target_loader_->PauseReadingBodyFromNet();
}

void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::ResumeReadingBodyFromNet() {
  if (target_loader_.is_bound())
    target_loader_->ResumeReadingBodyFromNet();
}

void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::OnReceiveEarlyHints(
    network::mojom::EarlyHintsPtr early_hints) {
  target_client_->OnReceiveEarlyHints(std::move(early_hints));
}

void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::OnReceiveResponse(
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::OnReceiveRedirect(
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::OnUploadProgress(
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::OnTransferSizeUpdated(
    int32_t transfer_size_diff) {
  target_client_->OnTransferSizeUpdated(transfer_size_diff);
}

void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::OnComplete(
  ...
  factory_->web_request_listener()->OnCompleted(&info_.value(), request_,
                                       status.error_code);
  // Deletes |this|.
  factory_->RemoveRequest(network_service_request_id_, request_id_);
}

bool AppRuntimeProxyingURLLoaderFactory::IsForServiceWorkerScript() const {
  return loader_factory_type_ == content::ContentBrowserClient::
                                     URLLoaderFactoryType::kServiceWorkerScript;
}

void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::OnLoaderCreated(
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::OnHeadersReceived(
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::ContinueToBeforeSendHeaders(
    int error_code) {
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::ContinueToStartRequest(
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
    return;
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::ContinueToSendHeaders(
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::
  ...
  if (for_cors_preflight_) {
    ...
    factory_->web_request_listener()->OnResponseStarted(&info_.value(), request_);
    factory_->web_request_listener()->OnCompleted(&info_.value(), request_, net::OK);
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::ContinueToResponseStarted(
    int error_code) {
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::ContinueToBeforeRedirect(
    const net::RedirectInfo& redirect_info,
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
  ...
  factory_->web_request_listener()->OnBeforeRedirect(&info_.value(), request_,
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::
  ...
  int result = factory_->web_request_listener()->OnHeadersReceived(
...
void AppRuntimeProxyingURLLoaderFactory::InProgressRequest::OnRequestError(
    const network::URLLoaderCompletionStatus& status) {
  if (target_client_)
    target_client_->OnComplete(status);
  factory_->web_request_listener()->OnErrorOccurred(&info_.value(), request_,
                                               status.error_code);
...
AppRuntimeProxyingURLLoaderFactory::AppRuntimeProxyingURLLoaderFactory(
    AppRuntimeWebRequestListener* web_request_listener,
    ...
    : web_request_listener_(web_request_listener),
  ...
  target_factory_.set_disconnect_handler(base::BindOnce(
      &AppRuntimeProxyingURLLoaderFactory::OnTargetFactoryError,
      base::Unretained(this)));
  proxy_receivers_.Add(this, std::move(loader_request));
  proxy_receivers_.set_disconnect_handler(base::BindRepeating(
      &AppRuntimeProxyingURLLoaderFactory::OnProxyBindingError,
      base::Unretained(this)));
...
bool AppRuntimeProxyingURLLoaderFactory::ShouldIgnoreConnectionsLimit(
    const network::ResourceRequest& request) {
  return false;
}

void AppRuntimeProxyingURLLoaderFactory::CreateLoaderAndStart(
  ...
  if (!web_request_listener()->HasHandlers()) {
...
void AppRuntimeProxyingURLLoaderFactory::Clone(
    mojo::PendingReceiver<network::mojom::URLLoaderFactory> loader_receiver) {
  proxy_receivers_.Add(this, std::move(loader_receiver));
}

void AppRuntimeProxyingURLLoaderFactory::OnLoaderCreated(
    int32_t request_id,
    mojo::PendingReceiver<network::mojom::TrustedHeaderClient> receiver) {
...
void AppRuntimeProxyingURLLoaderFactory::OnLoaderForCorsPreflightCreated(
    const network::ResourceRequest& request,
    mojo::PendingReceiver<network::mojom::TrustedHeaderClient> receiver) {
...
void AppRuntimeProxyingURLLoaderFactory::OnTargetFactoryError() {
...
void AppRuntimeProxyingURLLoaderFactory::OnProxyBindingError() {
...
void AppRuntimeProxyingURLLoaderFactory::RemoveRequest(
    int32_t network_service_request_id,
    uint64_t request_id) {
...
void AppRuntimeProxyingURLLoaderFactory::MaybeDeleteThis() {
