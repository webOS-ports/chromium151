...
void AppRuntimeBrowserMainParts::PostCreateMainMessageLoop() {
  ...
  // M151: os_crypt::Config and OSCrypt::SetConfig() no longer exist. Cookie
  // encryption is configured per NetworkContext in
  // AppRuntimeContentBrowserClient::ConfigureNetworkContextParams().
}
