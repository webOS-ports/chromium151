...
// Based on //chrome/browser/notifications/notification_handler.h.

#ifndef NEVA_APP_RUNTIME_BROWSER_NOTIFICATIONS_NOTIFICATION_HANDLER_H_
#define NEVA_APP_RUNTIME_BROWSER_NOTIFICATIONS_NOTIFICATION_HANDLER_H_
...
class NotificationHandler {
 public:
  ...
  virtual void OnClose(content::BrowserContext* profile,
                       const GURL& origin,
                       const std::string& notification_id,
                       bool by_user,
  ...
  virtual void OnClick(content::BrowserContext* profile,
                       const GURL& origin,
                       const std::string& notification_id,
  ...
  virtual void DisableNotifications(content::BrowserContext* profile,
                                    const GURL& origin);

  // Called when the settings page for the given origin has to be opened.
  virtual void OpenSettings(content::BrowserContext* profile,
                            const GURL& origin);
};

}  // namespace neva_app_runtime

#endif  // NEVA_APP_RUNTIME_BROWSER_NOTIFICATIONS_NOTIFICATION_HANDLER_H_
