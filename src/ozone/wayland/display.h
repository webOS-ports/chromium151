...
class WaylandDisplay : public ui::SurfaceFactoryOzone,
 ...
 public:
  ...
  void OnKeyboardAdded(const int device_id, const std::string& name);
  void OnKeyboardRemoved(const int device_id);
  void OnPointerAdded(const int device_id, const std::string& name);
  void OnPointerRemoved(const int device_id);
  void OnTouchscreenAdded(const int device_id, const std::string& name);
  void OnTouchscreenRemoved(const int device_id);
