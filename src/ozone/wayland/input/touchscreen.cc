...
void WaylandTouchscreen::OnTouchDown(void *data,
  ...
  WaylandDisplay::GetInstance()->TouchNotify(
      device_id, seat->GetEnteredWindowHandle(device_id), ui::EventType::kTouchPressed,
      event_info);
}
...
void WaylandTouchscreen::OnTouchUp(void *data,
  ...
  WaylandDisplay::GetInstance()->TouchNotify(
      device_id, seat->GetEnteredWindowHandle(device_id), ui::EventType::kTouchReleased,
      event_info);
...
void WaylandTouchscreen::OnTouchMotion(void *data,
  ...
  WaylandDisplay::GetInstance()->TouchNotify(
      device_id, seat->GetEnteredWindowHandle(device_id), ui::EventType::kTouchMoved,
      event_info);
}
...
void WaylandTouchscreen::OnTouchCancel(void *data,
  ...
  WaylandDisplay::GetInstance()->TouchNotify(
      ...
      ui::EventType::kTouchCancelled, event_info);
