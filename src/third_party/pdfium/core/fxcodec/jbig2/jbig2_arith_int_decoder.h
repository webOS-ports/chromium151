...
#ifndef CORE_FXCODEC_JBIG2_JBIG2_ARITH_INT_DECODER_H_
#define CORE_FXCODEC_JBIG2_JBIG2_ARITH_INT_DECODER_H_
...
#endif  // CORE_FXCODEC_JBIG2_JBIG2_ARITH_INT_DECODER_H_
