...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ETWCONFIG']._serialized_end=308
  _globals['_ETWCONFIG_KERNELFLAG']._serialized_start=267
  _globals['_ETWCONFIG_KERNELFLAG']._serialized_end=308
