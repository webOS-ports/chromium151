...
from protos.perfetto.config.android import android_aflags_config_pb2 as protos_dot_perfetto_dot_config_dot_android_dot_android__aflags__config__pb2
...
from protos.perfetto.config.android import inputmethod_config_pb2 as protos_dot_perfetto_dot_config_dot_android_dot_inputmethod__config__pb2
...
from protos.perfetto.config.android import user_list_config_pb2 as protos_dot_perfetto_dot_config_dot_android_dot_user__list__config__pb2
...
from protos.perfetto.config.protovm import protovm_config_pb2 as protos_dot_perfetto_dot_config_dot_protovm_dot_protovm__config__pb2
...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_DATASOURCECONFIG'].fields_by_name['user_list_config']._loaded_options = None
  _globals['_DATASOURCECONFIG'].fields_by_name['user_list_config']._serialized_options = b'(\001'
  _globals['_DATASOURCECONFIG'].fields_by_name['inputmethod_config']._loaded_options = None
  _globals['_DATASOURCECONFIG'].fields_by_name['inputmethod_config']._serialized_options = b'(\001'
  _globals['_DATASOURCECONFIG'].fields_by_name['android_aflags_config']._loaded_options = None
  _globals['_DATASOURCECONFIG'].fields_by_name['android_aflags_config']._serialized_options = b'(\001'
  _globals['_DATASOURCECONFIG'].fields_by_name['qnx_config']._loaded_options = None
  _globals['_DATASOURCECONFIG'].fields_by_name['qnx_config']._serialized_options = b'(\001'
  _globals['_DATASOURCECONFIG']._serialized_start=2623
  _globals['_DATASOURCECONFIG']._serialized_end=6449
  _globals['_DATASOURCECONFIG_SESSIONINITIATOR']._serialized_start=6181
  _globals['_DATASOURCECONFIG_SESSIONINITIATOR']._serialized_end=6272
  _globals['_DATASOURCECONFIG_BUFFEREXHAUSTEDPOLICY']._serialized_start=6275
  _globals['_DATASOURCECONFIG_BUFFEREXHAUSTEDPOLICY']._serialized_end=6436
