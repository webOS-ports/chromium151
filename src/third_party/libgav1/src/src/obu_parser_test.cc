...
TEST_F(ObuParserTest, InvalidLevel) {
  // 640x480, Level 3.0, 4 row tiles, 5 column tiles.
  const std::vector<uint8_t> kFrame1 = {
      0x12, 0x00, 0x0a, 0x07, 0x19, 0x26, 0x27, 0xfe, 0xff, 0x60, 0x10, 0x32,
      0x6d, 0x1f, 0x80, 0xff, 0x00, 0x00, 0x05, 0x80, 0x00, 0x00, 0x00, 0x03,
      0x03, 0xad, 0x19, 0xcf, 0x03, 0x03, 0xad, 0x19, 0xcf, 0x03, 0x03, 0xad,
      0x19, 0xcf, 0x03, 0x03, 0xad, 0x19, 0xcf, 0x03, 0x03, 0xad, 0x19, 0xcf,
      0x03, 0x03, 0xad, 0x19, 0xcf, 0x03, 0x03, 0xad, 0x19, 0xcf, 0x03, 0x03,
      0xad, 0x19, 0xcf, 0x03, 0x03, 0xad, 0x19, 0xcf, 0x03, 0x03, 0xad, 0x19,
      0xcf, 0x03, 0x03, 0xad, 0x19, 0xcf, 0x03, 0x03, 0xad, 0x19, 0xcf, 0x03,
      0x03, 0xad, 0x19, 0xcf, 0x03, 0x03, 0xad, 0x19, 0xcf, 0x03, 0x03, 0xad,
      0x19, 0xcf, 0x03, 0x03, 0xad, 0x19, 0xcf, 0x03, 0x03, 0xad, 0x19, 0xcf,
      0x03, 0x03, 0xad, 0x19, 0xcf, 0x03, 0x03, 0xad, 0x19, 0xcf, 0x03, 0xad,
      0x19, 0xcf};
  // 640x360, Level 2.1, 1 row tile, 5 column tiles.
  const std::vector<uint8_t> kFrame2 = {
      0x12, 0x00, 0x0a, 0x07, 0x18, 0x66, 0x27, 0xfb, 0x3f, 0x60, 0x10, 0x32,
      0x2c, 0x1e, 0x07, 0xf8, 0x00, 0x00, 0x2c, 0x00, 0x00, 0x20, 0x00, 0x05,
      0x00, 0xa9, 0x57, 0xf7, 0x4d, 0x78, 0x05, 0x00, 0xa9, 0x57, 0xf7, 0x4d,
      0x78, 0x05, 0x00, 0xa9, 0x57, 0xf7, 0x4d, 0x78, 0x05, 0x00, 0xa9, 0x57,
      0xf7, 0x4d, 0x78, 0x00, 0xa9, 0x57, 0xf7, 0x4d, 0x78};
  // 2049x16, Level 2.0.
  const std::vector<uint8_t> kFrame3 = {
      0x12, 0x00, 0x0a, 0x07, 0x18, 0x2c, 0xe0, 0x03, 0xfb, 0x00, 0x80, 0x32,
      0x17, 0x17, 0xf8, 0x00, 0x00, 0x2c, 0x00, 0x00, 0x20, 0x00, 0xb1, 0x7c,
      0x17, 0x85, 0x20, 0x21, 0xbe, 0x5b, 0x32, 0xd9, 0x66, 0xfa, 0x24, 0x80};
  // 16x1153, Level 2.0.
  const std::vector<uint8_t> kFrame4 = {
      0x12, 0x00, 0x0a, 0x06, 0x18, 0x0e, 0xbe, 0x40, 0x76, 0x01, 0x32,
      0x13, 0x17, 0xf8, 0x00, 0x00, 0x2c, 0x00, 0x00, 0x20, 0x00, 0xb1,
      0x7c, 0x17, 0x88, 0x94, 0x74, 0x77, 0x9f, 0x1d, 0x40};
  // 1280x720, Level 3.0.
  const std::vector<uint8_t> kFrame5 = {
      0x12, 0x00, 0x0a, 0x07, 0x19, 0x2a, 0x67, 0xfd, 0x9f, 0xd8,
      0x04, 0x32, 0x1a, 0x13, 0xfc, 0x00, 0x00, 0x16, 0x00, 0x00,
      0x10, 0x00, 0xa9, 0x57, 0xf7, 0x4d, 0x6e, 0x08, 0x39, 0x26,
      0x28, 0x36, 0x50, 0xed, 0xc1, 0x18, 0x35, 0x9c, 0x20};

  // MaxTiles failure.
  EXPECT_FALSE(Parse(kFrame1));
  // MaxTileCols failure.
  EXPECT_FALSE(Parse(kFrame2));
  // MaxHSize failure.
  EXPECT_FALSE(Parse(kFrame3));
  // MaxVSize failure.
  EXPECT_FALSE(Parse(kFrame4));
  // MaxPicSize failure.
  EXPECT_FALSE(Parse(kFrame5));
}
