...
class HTMLMediaElement {
 public:
  ...
  const gfx::Rect VideoRectInScreen() const;
  const gfx::Rect WidgetViewRect() const;
 ...
 protected:
  ...
  std::optional<bool> has_noaudio_attr_ = std::nullopt;
};
...
template <typename original_t>
const gfx::Rect HTMLMediaElement<original_t>::VideoRectInScreen() const {
...
template <typename original_t>
const gfx::Rect HTMLMediaElement<original_t>::WidgetViewRect() const {
  const original_t* self(static_cast<const original_t*>(this));
...
void HTMLMediaElement<original_t>::SetMaxTimeupdateEventFrequency() {
  ...
  if (frame) {
    ...
    if (settings) {
      kMaxTimeupdateEventFrequency =
          base::Milliseconds(settings->GetMaxTimeupdateEventFrequency());
    }
  }
}
...
class HTMLMediaElementExtendingWebMediaPlayerClient
 ...
 public:
  ...
  std::optional<bool> IsAudioDisabled() const override;
...
template <typename original_t>
std::optional<bool> HTMLMediaElementExtendingWebMediaPlayerClient<
