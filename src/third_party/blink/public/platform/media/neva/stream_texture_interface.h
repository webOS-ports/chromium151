...
#ifndef THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MEDIA_NEVA_STREAM_TEXTURE_INTERFACE_H_
#define THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MEDIA_NEVA_STREAM_TEXTURE_INTERFACE_H_
...
class BLINK_PLATFORM_EXPORT StreamTextureFactoryInterface
...
class BLINK_PLATFORM_EXPORT StreamTextureProxyInterface {
 public:
...
#endif  // THIRD_PARTY_BLINK_PUBLIC_PLATFORM_MEDIA_NEVA_STREAM_TEXTURE_INTERFACE_H_
