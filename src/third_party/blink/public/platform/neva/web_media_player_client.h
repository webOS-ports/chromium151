...
class WebMediaPlayerClient {
 public:
  ...
  virtual std::optional<bool> IsAudioDisabled() const { return std::nullopt; }
  ...
  virtual void DidMediaCreated(bool will_use_media_resource) {}
  virtual void DidMediaActivated() {}
  virtual void DidMediaActivationNeeded() {}
  virtual void DidMediaSuspended() {}
