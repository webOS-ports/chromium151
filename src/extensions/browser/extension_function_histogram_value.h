...
enum HistogramValue {
  ...
  // webrtcAudioPrivate.
  DELETED_WEBRTC_AUDIO_PRIVATE_SET_AUDIO_EXPERIMENTS = 1170,
  ...
  DELETED_PASSWORDSPRIVATE_ISACCOUNTSTORAGEACTIVE = 1443,
  ...
  DELETED_PASSWORDSPRIVATE_SETACCOUNTSTORAGEENABLED = 1462,
  ...
  DELETED_ENTERPRISEREPORTINGPRIVATE_ENQUEUERECORD = 1651,
  ...
  DELETED_PASSWORDSPRIVATE_EXTENDAUTHVALIDITY = 1701,
  ...
  DELETED_PASSWORDSPRIVATE_SWITCHBIOMETRICAUTHBEFOREFILLINGSTATE = 1717,
  ...
  DELETED_PASSWORDSPRIVATE_SHOWADDSHORTCUTDIALOG = 1726,
  ...
  DELETED_PASSWORDSPRIVATE_CHANGEPASSWORDMANAGERPIN = 1878,
  DELETED_PASSWORDSPRIVATE_ISPASSWORDMANAGERPINAVAILABLE = 1879,
  ...
  DELETED_PASSWORDSPRIVATE_DELETEALLPASSWORDMANAGERDATA = 1893,
  DELETED_DEVELOPERPRIVATE_DISMISSMV2DEPRECATIONNOTICEFOREXTENSION = 1894,
  ...
  DELETED_PASSWORDSPRIVATE_SHOULDSHOWACCOUNTSTORAGESETTINGTOGGLE = 1941,
  ...
  CONTEXTUALTASKSPRIVATE_GETSTATE = 1974,
