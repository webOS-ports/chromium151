...
class WEBOS_EXPORT WebViewBase
 ...
 public:
  // Deprecated API left to support backward compatibility with old WAMs
  ///@name DEPRECATED_API
  ///@{
  ...
  void ShowExistingAlertsIfAccessibilityIsEnabled();
  ...
  void SetAllowThirdPartyCookies(bool flag);
