...
void WebAppWindowBase::SetFirstActivateTimeoutMs(int timeout) {
  NOTIMPLEMENTED();
}
...
void WebAppWindowBase::SetFirstActivateTimeoutMs(uint32_t timeout) {
  webapp_window_->SetFirstActivateTimeout(base::Milliseconds(timeout));
}
